...
IL_002b:
	{
		...
		RuntimeObject * L_6 = Enumerator_get_Current_m337713592((Enumerator_t2146457487 *)L_5, /*hidden argument*/IL2CPP_RGCTX_METHOD_INFO(method->declaring_type->rgctx_data, 5));
		V_1 = (RuntimeObject *)L_6;
		Func_2_t3759279471 * L_7 = (Func_2_t3759279471 *)__this->get__predicate_4();
		RuntimeObject * L_8 = V_1;
		NullCheck((Func_2_t3759279471 *)L_7);
...
IL_004e:
	{
		...
		bool L_12 = Enumerator_MoveNext_m2142368520((Enumerator_t2146457487 *)L_11, /*hidden argument*/IL2CPP_RGCTX_METHOD_INFO(method->declaring_type->rgctx_data, 7));
		if (L_12)
		{
			goto IL_002b;
		}
